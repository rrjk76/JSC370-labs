...
of results returned by PubMed in the following web address:
    ...
    https://pubmed.ncbi.nlm.nih.gov/?term=sars-cov-2 -- used in the demo 
...
*There are 247,751 sars-cov-2 papers.*
...
query_ids <- GET(
  ...
  query = list(
    db = "pubmed",
    term = "covid19 toronto", # space => searching for covid19 and toronto
    retmax = 300
  )
)

# Extracting the content of the response of GET
ids <- httr::content(query_ids)  # output = xml, id's are the 4th item in the list 
```
...
publications <- GET(
  ...
  query = list(
    db = "pubmed",
    id = paste(ids, collapse = ","), # converts the numeric ids into a vector of ids, and each id is separated by a comma
    retmax = 300,
    rettype = "abstract"
    )
)
...
View Week 6 Tutorial HTML Page
[here](https://raw.githack.com/rrjk76/JSC370-labs/main/lab06/06-lab.html)

View Week 6 Tutorial HTML document
[here](https://cdn.jsdelivr.net/gh/rrjk76/JSC370-labs@main/lab06/06-lab.html)
